...
.text 
	# Declaracao de variaveis
 	...
 	jal copy_vet # Chamada de funcao para contar o numero de elementos do vetor
...
copy_vet:
	...
	sw $s4, 0($t1) # Copia o valor atual de v1 para v2
	
	lw $s5, 0($t1) # $s5, valor atual de v2
	
	# Impressao do valor atual do v2
	addi $v0, $zero, 1 # Codigo para imprimir um inteiro
	add $a0, $zero, $s5 # Valor atual de v2
	syscall
